    ...
    def _build_analysis_payload(
        *,
        ...
        return {
            ...
            "image_drive_file_id": image_drive_file_id,
            "estimated_calories": estimate.estimated_calories,
            "calorie_range_low": estimate.calorie_range_low,
            "calorie_range_high": estimate.calorie_range_high,
            "confidence": estimate.confidence,
            "summary": estimate.summary,
            "meal_items": estimate.meal_items,
            "components": [component.model_dump() for component in estimate.components],
            "rationale": estimate.rationale,
            "provider": estimate.provider,
            "model_name": estimate.model_name,
        }
