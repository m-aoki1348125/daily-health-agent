...
class MetricsRepository:
    ...
    def upsert_daily_metric(
        ...
        entity.weight_kg = metric.weight_kg
        entity.bmi = metric.bmi
        entity.body_fat_percent = metric.body_fat_percent
        entity.body_logged_at = metric.body_logged_at
    ...
    def upsert_trend_feature(self, trend: TrendFeatureInput) -> None:
        ...
        entity.weight_kg_vs_30d_avg = trend.weight_kg_vs_30d_avg
